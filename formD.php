    ...
    <div class="container-fluid position-relative bg-white d-flex p-0">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="buttonD.php" class="dropdown-item">Buttons</a>
                            <a href="typographyD.php" class="dropdown-item">Typography</a>
                            <a href="elementD.php" class="dropdown-item">Other Elements</a>
                        </div>
                    </div>
                    <a href="widgetD.php" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Widgets</a>
                    <a href="formD.php" class="nav-item nav-link active"><i class="fa fa-keyboard me-2"></i>Forms</a>
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                <a href="indexD.php" class="navbar-brand d-flex d-lg-none me-4">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light rounded-top p-4">
                    <div class="row">
                        <div class="col-12">
                            <h1>Add New Event</h1>
                            <form id="eventForm" action="View/addEvent.php" method="post" novalidate>
                                <input type="hidden" name="action" value="createEvent">
                                <div class="row mb-3">
                                    <label for="nom" class="col-sm-2 col-form-label">Event Name:</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="row mb-3">
                                    <label for="sujet" class="col-sm-2 col-form-label">Subject:</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="row mb-3">
                                    <label for="lieu" class="col-sm-2 col-form-label">Location:</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="row mb-3">
                                    <label for="organizateur" class="col-sm-2 col-form-label">Organizer's Name:</label>
                                    <div class="col-sm-10">
                                        <input type="text" id="organizateur" name="organizateur" class="form-control">
                                ...
                                <div class="row mb-3">
                                    <label for="frais" class="col-sm-2 col-form-label">Subscription fee:</label>
                                    <div class="col-sm-10">
                                        <input type="text" id="frais" name="frais" class="form-control">
                                        <div id="fraisError" class="error-message">Subscription fee is required</div>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="duree" class="col-sm-2 col-form-label">Event Duration:</label>
                                    <div class="col-sm-10">
