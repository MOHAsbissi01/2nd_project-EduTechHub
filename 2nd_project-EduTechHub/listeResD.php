...
<head>
    ...
    <title>Liste Résultats</title>    <meta content="width=device-width, initial-scale=1.0" name="viewport">
...
<!-- Section pour afficher la liste des cours dans un widget -->
        <div class="col-sm-12">
                    <div class="bg-light rounded h-100 p-4">
                        <!-- Titre du widget -->
                        <h6 class="mb-4">Liste des Résultats</h6>
                        <!-- Widget contenant le contenu de listecours.php -->
                        <div class="card">
                            <div class="card-body">
                                <?php include '../view/listeResult.php'; ?>
                            </div>
                        </div>
                    </div>
        </div>
