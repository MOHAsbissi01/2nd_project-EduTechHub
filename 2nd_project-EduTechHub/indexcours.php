...
<header>
    ...
    <button class="filter-button" onclick="filterByType(0)">Toutes les cours</button>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="../FRONTEND/about.html">Story</a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="../FRONTEND/faq.html">FAQs</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" href="../FRONTEND/contact.html">Contact</a>
                </li>
            </ul>
...
<span style="color: orange;">Edu</span>
