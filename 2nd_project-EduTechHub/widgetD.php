        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-book me-2"></i>Documents</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="view/addCours.php" class="dropdown-item">Ajouter Doc</a>
                            <a href="view/deleteCours.php" class="dropdown-item">Supprimer Doc</a>
                            <a href="view/updatecours.php" class="dropdown-item">Modifier Doc</a>
                            <a href="view/listecours.php" class="dropdown-item">Liste doc</a>
                        </div>
                    </div>
                    <a href="widgetD.php" class="nav-item nav-link active"><i class="fa fa-th me-2"></i>Widgets</a>
                    ...
                    <div class="col-sm-12 col-md-6 col-xl-4">
                        <div class="h-100 bg-light rounded p-4">
                            ...
                            <div class="d-flex align-items-center border-bottom py-3">
                                <img class="rounded-circle flex-shrink-0" src="imgD/user.jpg" alt="" style="width: 40px; height: 40px;">
                        ...
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <div class="owl-carousel testimonial-carousel">
                                <div class="testimonial-item text-center">
                                    <img class="img-fluid rounded-circle mx-auto mb-4" src="imgD/testimonial-1.jpg" style="width: 100px; height: 100px;">
                                    <h5 class="mb-1">Client Name</h5>
                                    <p>Profession</p>
                                    <p class="mb-0">Dolor et eos labore, stet justo sed est sed. Diam sed sed dolor stet amet eirmod eos labore diam</p>
                                </div>
                                <div class="testimonial-item text-center">
                                    <img class="img-fluid rounded-circle mx-auto mb-4" src="imgD/testimonial-2.jpg" style="width: 100px; height: 100px;">
                                    <h5 class="mb-1">Client Name</h5>
                                    <p>Profession</p>
                                    <p class="mb-0">Dolor et eos labore, stet justo sed est sed. Diam sed sed dolor stet amet eirmod eos labore diam</p>
                                </div>
